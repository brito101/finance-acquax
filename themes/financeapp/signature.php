...
<?php else : ?>
    <article class="app_signature radius">
        <header class="app_signature_header gradient gradient-orange">
            <span class="icon icon-money icon-notext"></span>
            <!--<h2>Seja PRO por apenas R$ 0,16 centavos por dia e controle tudo!</h2>-->
            <h2>Seja PRO por apenas R$ 5,00 mensais e controle tudo!</h2>
            <p>Crie multiplas empresas para controlar suas finanças PF, PJ, contas bancárias, cartões de crédito,
        ...
        <section class="app_signature_resources">
            <div class="app_signature_resources_overflow">
                ...
                <div class="app_signature_resources_item title">
                    ...
                    <p class="check icon-money">PRO</p>
                </div>
                ...
                <article class="app_signature_resources_item">
                    <p class="resouce">Empresas ilimitadas</p>
                ...
                <article class="app_signature_resources_item">
                    <p class="resouce">Filtro por fonte (empresa)</p>
                    <p class="check icon-error icon-notext"></p>
                    <p class="check icon-check icon-notext"></p>
                </article>
                <article class="app_signature_resources_item">
        ...
        <article class="app_signature_pay">
            ...
            <?php else : ?>
                <header>
                    <h2 class="icon-money">Assine o PRO</h2>
                    <p>E libere todos os recursos do FinanceApp</p>
                </header>
